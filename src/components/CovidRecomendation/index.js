    ...
    <div className={classes.recomendation}>
        ...
        <Popup text="VER">
            <ul className={classes.list}>
                ...
                <li className={classes.item}>Recordar mantener tus manos limpias. Contarás con un kit de higiene disponible en todo momento ubicado en tu mesa y diversas secciones del salón.</li>
